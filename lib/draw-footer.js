...
const FOOTER_TEXT = {
	...
	version: "Все права защищены - Версия отчета 2.07",
};
...
const FOOTER_STYLE = {
	...
	rowGap: 3.6,
	columnGap: 6,
	pageNumberFontSize: 4.9,
	metaFontSize: 4.1,
	disclaimerFontSize: 5.5,
	disclaimerLineStep: 2.8,
...
function drawRightMetaLine(doc, text, x, y, width) {
...
function drawRightColumn(doc, layout) {
	...
	doc.text(
		...
		layout.rightEdge,
		layout.rowY + FOOTER_STYLE.rowGap,
		{ align: "right" },
	);
	drawRightMetaLine(
		doc,
		FOOTER_TEXT.version,
		layout.rightEdge,
		layout.rowY + FOOTER_STYLE.rowGap * 2,
		layout.rightColumnW,
	);
}
