...
import { drawDateCollectedRight } from './draw-header.js';

export function createTableHooks(doc, tableBody, tableRowRefs, patient, doctor, specimen) {
  return {
    ...
    didParseCell(hookData) {
      ...
      if (hookData.column.index === 0) {
        hookData.cell.styles.fontStyle = rowRef && rowRef.row.outOfRange ? 'bold' : 'normal';
        hookData.cell.styles.cellPadding = { top: 0.55, bottom: 0.55, left: 7, right: 1.8 };
      }
    },
